...
{
    [Bot("AlgoStart1LinearRegressionReverse")]
    public class AlgoStart1LinearRegressionReverse : BotPanel
    {
        ...
        public AlgoStart1LinearRegressionReverse(string name, StartProgram startProgram) : base(name, startProgram)
        {
        ...
        private void _screenerTab_CandleFinishedEvent(List<Candle> candles, BotTabSimple tab)
        {
            ...
            if (positions.Count == 0) // Logic open position
            {
